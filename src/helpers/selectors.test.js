  ...
  days: [
    {
      ...
      name: "Monday",
      appointments: [1, 2, 3],
      interviewers: ['Susan Reynolds', 'Jane Doe']
    },
    {
      id: 2,
      name: "Tuesday",
      appointments: [4, 5],
      interviewers: ['Jim Clark', 'Lewis Hamilton', 'Steph Curry']
    }
  ],
...
test("getInterviewersForDay returns an array containing the correct appointment objects", () => {
  ...
  expect(first).toEqual(state.interviewers["Lewis Hamilton"]);
  expect(second).toEqual(state.interviewers["Steph Curry"]);
});
